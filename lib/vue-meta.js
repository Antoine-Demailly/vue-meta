...
function _updateClientMetaInfo (options) {
  ...
  return function updateClientMetaInfo (newInfo, preventChangedHook) {
    ...
    if (htmlTag.getAttribute(ssrAttribute) === null) {
      ...
      if (typeof newInfo.changed === 'function' && !preventChangedHook && !Object.keys(addedTags).length && !Object.keys(removedTags).length) {
...
function _refresh (options) {
  ...
  return function refresh (preventChangedHook) {
    var info = _getMetaInfo(options)(this.$root);
    _updateClientMetaInfo(options).call(this, info, preventChangedHook);
    return info
  }
}
    ...
    destroyed: function destroyed () {
      ...
      if (this._hasMetaInfo) {
        ...
        var interval = setInterval(function () {
          ...
          batchID = batchUpdate(batchID, function () { return this$1.$meta().refresh(true); });
        }, 50);
      }
    }
  });
